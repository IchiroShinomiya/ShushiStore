...
// When the scroll is higter than 350 viewport height, add the show-scroll class to the a tag with the scrollup
...
sr.reveal(`.about__image, .recently__image-img`, {origin: 'right'})
